...
/***/ function(module, exports, __webpack_require__) {
	...
	var _messReducer = __webpack_require__(18);
	...
	console.log(_messReducer.messReducer);
	var store = (0, _redux.createStore)(_messReducer.messReducer);
	ReactDOM.render(React.createElement(Main, { socket: so, store: store }), document.querySelector('body'));
	// });
...
/***/ function(module, exports) {
	...
	var messReducer = function messReducer() {
	   var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	   var action = arguments[1];
	...
	exports.messReducer = messReducer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TopBar = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var checkReactTypeSpec = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dinput = __webpack_require__(58);
	var Chat = __webpack_require__(59);
	var List = React.createClass({
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(Dinput, { type: 'Chat!' })
			);
		}
	});
	...
	var Dinput = React.createClass({
		...
		render: function render() {
			if (this.props.type === 'Chat!') {
				return React.createElement('input', { type: 'text', className: 'Bin', onKeyDown: this.upload, placeholder: this.props.type });
			} else {
				return React.createElement('input', { type: 'text', className: 'Bin', placeholder: this.props.type });
			}
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var messChange = __webpack_require__(60);
	var Chat = React.createClass({
	   ...
	   initialBind: function initialBind() {
	      var ok;
	   ...
	   componentDidMount: function componentDidMount(prevProps, prevState, prevContext) {
	   ...
	   render: function render() {
	      ...
	      this.state.content.forEach(function (item, index) {
	         messList.push(React.createElement(
	            'div',
	            { className: 'mess', refs: index },
	            item
	         ));
	      });
	      return React.createElement(
	         'div',
	         { className: 'chatbox', ref: function ref(_ref) {
	               return _this2.chatbox = _ref;
	            } },
	         messList
	      );
	   }
...
/***/ function(module, exports) {
	...
	var messChange = function messChange(mess) {
	   return {
	      type: 'newMess',
	      content: mess
	   };
